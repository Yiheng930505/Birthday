function showTime() { 
	...
	var startDate = new Date(2019, 01, 15);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "<br> <br> <br> <br> Dear Xiaoyu:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Times New Roman; font-size:20px\" >--hengheng   <br> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp 2019-03-21</c>"; 
